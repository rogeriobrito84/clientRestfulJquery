...
(function($) {
    ...
    BootstrapDialog.prototype = {
        ...
        createModalDialog: function() {
        	...
        	if(this.options.width == "lg"){        		
        		modalDialog = $('<div class="modal-dialog modal-lg"></div>');
        	}else if(this.options.width == "sm"){
        ...
        createModalFooter: function() {
        	...
        	if(this.options.footer != ''){
        		modalFooter = $('<div class="modal-footer">' + this.options.footer  +'</div>');
        	}
            return modalFooter;
        },
...
//        },
     ...
     * @returns the created dialog instance
     */
    BootstrapDialog.confirm = function(message, callback, labelCancel, labelOk) {
    	if(labelCancel == undefined || labelCancel == null){
    		labelCancel = "Não";
    	}
    	if(labelOk == undefined || labelOk == null){
    		labelOk = "Sim";
    	}
        return new BootstrapDialog({
            title: 'Confirmação',
